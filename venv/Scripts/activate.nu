...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\PycharmProjects\flaskProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\PycharmProjects\flaskProject\venv\Scripts\deactivate.nu'
